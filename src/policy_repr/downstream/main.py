...
from policy_repr.datasets.psro import load_ppo_agents_from_psro, make_neupl_policies
from policy_repr.utils import PPOAgentPolicy, get_device_string, make_diverse_random_kuhn_poker_layer_init
from policy_repr.encoders.functional_autoencoder import (
    TrainingConfig,
...
def test_downstream_task_a(
    ...
    predictor = PayoffPredictor(
        ...
        # TODO: we're detaching and moving to cpu/numpy here, but then later we just put them on the device anyways.
