#!/bin/bash
#SBATCH --job-name=cmp_kuhn
#SBATCH --output=logs/compare_encoders_kuhn_%j.out
#SBATCH --error=logs/compare_encoders_kuhn_%j.err
...
SEED=${SEED:-42}
echo "=== Running Kuhn Poker comparison (seed=$SEED) ==="
