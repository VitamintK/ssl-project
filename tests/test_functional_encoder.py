...
from policy_repr.encoders.weight_autoencoder import ppo_agent_to_vector, AutoencoderConfig
...
def load_functional_encoder_from_checkpoint(checkpoint_path: str, device: str = "cpu"):
    ...
    from policy_repr.encoders.weight_autoencoder import Autoencoder
